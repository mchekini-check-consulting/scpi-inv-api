...
-- ***********************TEMPORAIRE **************************************************************************
--: Création manuelle des tables Spring Batch
-- Ceci est uniquement pour permettre l’insertion des SCPI dans la table
-- Ces tables devraient normalement être créées automatiquement par Spring Batch / Flyway
